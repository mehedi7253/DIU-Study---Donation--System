<?php
    ...
    include 'php/teacher_config.php';
        ...
        <div class="col-md-12 col-sm-12 mt-5 mb-5">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="text-info font-weight-bold mb-3"><?php echo $data['first_name']?> <span><?php echo $data['last_name']?></span> Profile <span><a href="index.php" class="btn btn-info float-right">Home</a></span></h4>
                </div>
                <div class="card-body">
