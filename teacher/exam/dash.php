...
<div class="row">
<div class="col-lg-6">
<span class="logo">Add Question And Test Student Skill</span></div>
<?php
...
//
//include_once 'dbConnection.php';
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;</span> <a href="" class="log log1 text-capitalize">'.$userdata['first_name'].' '.$userdata['last_name'].'</a>&nbsp;|&nbsp</span>';
//}?>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>Test Student Skill</b></a>
    </div>
    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          <li><a href="../teacher_dasboard.php" target="_parent">Home</a></li>
          <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0">Quiz<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1">Student's</a></li>
...
<!--home start-->
    ...
    <?php if(@$_GET['q']==0) {
        ...
        $result = mysqli_query($connect,"SELECT * FROM quiz ORDER BY date DESC") or die('Error');
...
<tr><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
	...
	<td><b><a href=""'.$eid.'&n=1&t='.$total.'">&nbsp;</a></b></td></tr>';
...
if(@$_GET['q']== 2) 
{
$q=mysqli_query($connect,"SELECT * FROM rank  ORDER BY score DESC " )or die('Error223');
...
$result = mysqli_query($connect,"SELECT * FROM user") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
