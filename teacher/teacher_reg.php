            ...
            <div class="col-8 mx-auto mt-5">
                 <div class="card mt-5">
                     <div class="card-header">
                         ...
                         //check login
                         if(logged_in() === TRUE) {
                             header('location: teacher.php'); //redirect page
                         }
                         ...
                         if($_POST) {
                             ...
                             if($fname && $lname && $username && $nid && $password && $cpassword) {
                     ...
                     <div class="card-body">
                         <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                             ...
                             <div  class="form-group">
                                 ...
                                 <input type="password" name="cpassword" placeholder="Conform Password" class="form-control" autocomplete="off" />
                             </div>
                             <div class="form-group">
                     ...
                     <div class="card-footer">
                         <p class="float-right">Already Registered ? Click <a href="teacher_login.php"><span class="text-info">Login</span></a></p>
                     </div>
                 </div>
            </div>
        </div>
