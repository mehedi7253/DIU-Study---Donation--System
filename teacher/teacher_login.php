                ...
                <div class="card mt-5">
                    <div class="card-header">
                        ...
                        <?php
                            ...
                            //check login
                            if(logged_in() === TRUE) {
                                header('location: teacher_dasboard.php'); //redirect page
                            }
                    ...
                    <div class="card-footer">
                        <p class="float-right">Not Registered ? Click <a href="teacher_reg.php"><span class="text-info">Register</span></a></p>
                    </div>
                </div>
            </div>
        </div>
