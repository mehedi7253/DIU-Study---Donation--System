    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Approve Exchange Post</li>
            </ol>
            ...
            <div class="container">
                <div class="row">
                    <?php
                        $sql = "SELECT * FROM request_exchange";
                        ...
                        <div class="col-md-4 col-sm-12 float-left mt-2">
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    ...
                                    if (($status) == '0'){?>
                                        <a href="update_exchange_status.php?status=<?php echo $row['exchange_id'];?>"><button class="btn btn-danger">Pending</button></a>
                                        <?php
                                    }
                                    if (($status) == '1'){?>
                                             <a href="update_exchange_status.php?status=<?php echo $row['exchange_id'];?>"><button class="btn btn-success">Apporved</button></a>
                                        <?php
                                    }
                                    ?>
                                </div>
